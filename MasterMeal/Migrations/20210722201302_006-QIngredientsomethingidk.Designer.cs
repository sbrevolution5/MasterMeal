...
namespace MasterMeal.Migrations
{
    ...
    [Migration("20210722201302_006-QIngredientsomethingidk")]
    partial class _006QIngredientsomethingidk
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MasterMeal.Models.IngredientType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("MasterMeal.Models.Recipe", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("MasterMeal.Models.RecipeType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("MasterMeal.Models.Comment", b =>
                {
                    ...
                    b.HasOne("MasterMeal.Models.Recipe", "Recipe")
                        .WithMany()
            ...
            modelBuilder.Entity("MasterMeal.Models.Ingredient", b =>
                {
                    b.HasOne("MasterMeal.Models.IngredientType", "Type")
                        .WithMany()
            ...
            modelBuilder.Entity("MasterMeal.Models.Recipe", b =>
                {
                    ...
                    b.HasOne("MasterMeal.Models.RecipeType", "Type")
                        .WithMany()
                        .HasForeignKey("TypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MasterMeal.Models.Supply", b =>
                {
                    b.HasOne("MasterMeal.Models.Recipe", null)
                        .WithMany("Supplies")
                        .HasForeignKey("RecipeId");
                });
